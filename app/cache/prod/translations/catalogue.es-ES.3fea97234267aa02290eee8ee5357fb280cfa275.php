...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'No image was found for combination with id_product = %s and image position = %s.' => 'Ninunga imagen encontrada por la combinación con id_product = %s, y la posición de la imagen = %s.',
