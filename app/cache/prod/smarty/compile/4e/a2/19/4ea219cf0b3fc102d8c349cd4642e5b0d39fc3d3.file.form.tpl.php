<?php /* Smarty version Smarty-3.1.19, created on 2018-03-08 02:40:11
         compiled from "C:\wamp64\www\prestashop\modules\smartblog\views\templates\admin\blog_post\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207915aa0ccbb5cabd3-74364324%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ea219cf0b3fc102d8c349cd4642e5b0d39fc3d3' => 
    array (
      0 => 'C:\\wamp64\\www\\prestashop\\modules\\smartblog\\views\\templates\\admin\\blog_post\\helpers\\form\\form.tpl',
      1 => 1516277800,
      2 => 'file',
    ),
    '4610fda4c54a5162ad777bc0468c07c8f3359cac' => 
    array (
      0 => 'C:\\wamp64\\www\\prestashop\\adminqq\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1520305313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207915aa0ccbb5cabd3-74364324',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa0ccbedacfa4_20229317',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa0ccbedacfa4_20229317')) {function content_5aa0ccbedacfa4_20229317($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\prestashop\\vendor\\prestashop\\smarty\\plugins\\function.counter.php';
?>
...
?>
				...
				<?php if ($_smarty_tpl->tpl_vars['key']->value=='gallary') {?>
	...
	<div class="panel-heading tab" >
		<?php echo smartyTranslate(array('s'=>'Images'),$_smarty_tpl);?>
			 ...
			 <?php if (isset($_smarty_tpl->tpl_vars['id_smart_blog_post']->value)&&($_smarty_tpl->tpl_vars['id_smart_blog_post']->value>0)) {?>
...
">
					<?php if (isset($_smarty_tpl->tpl_vars['id_image']->value)) {?><?php echo smartyTranslate(array('s'=>'Edit this gallery\'s image:'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add a new image to this Gallery'),$_smarty_tpl);?>
<?php }?>
				</span>
			</label>
			<div class="col-lg-9">
...
?>
	...
	<table id="lineType" style="display:none;">
		<tr id="image_id">
			<td>				
				<a href="<?php echo $_smarty_tpl->tpl_vars['gallary_path']->value;?>
image_path.jpg" class="fancybox">                                    
					<img
						src="<?php echo $_smarty_tpl->tpl_vars['gallary_path']->value;?>
...
"))
				doAdminAjax({
						...
						"id_smart_blog_post" : <?php echo $_smarty_tpl->tpl_vars['id_smart_blog_post']->value;?>
,
...
",
		...
		<?php } else { ?>
	<div class="alert alert-warning">  <?php echo smartyTranslate(array('s'=>'You must save this post before adding images.'),$_smarty_tpl);?>
  </div>
...
<?php }?>_counter"));
										...
										<?php }?>
									<?php }?>
								<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='blog_post_type') {?>
...
"<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]==$_smarty_tpl->tpl_vars['value']->value['value']) {?> checked="checked"<?php }?><?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?> disabled="disabled"<?php }?>/><i class="<?php echo $_smarty_tpl->tpl_vars['value']->value['icon'];?>
"></i> <?php echo $_smarty_tpl->tpl_vars['value']->value['label'];?>
</label>
										</div>
								...
								<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='associations') {?>
								 
								<div class="col-lg-5">
								<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
" id="inputAccessories" value="<?php  $_smarty_tpl->tpl_vars['accessory'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['accessory']->_loop = false;
...
foreach ($_from as $_smarty_tpl->tpl_vars['accessory']->key => $_smarty_tpl->tpl_vars['accessory']->value) {
$_smarty_tpl->tpl_vars['accessory']->_loop = true;
?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['accessory']->value['name'],'html','UTF-8');?>
¤<?php } ?>" />
...
<?php } else { ?> textarea-autosize<?php }?><?php }?>"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']],'html','UTF-8');?>
</textarea>
									<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>	
										</div>
										<div class="col-lg-2">
...
<?php }?><?php } else { ?> textarea-autosize<?php }?>"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']],'html','UTF-8');?>
</textarea>
									<?php }?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '207915aa0ccbb5cabd3-74364324');
content_5aa0ccbdbed088_31165641($_smarty_tpl);
...
/*  End of included template "helpers/form/form_group.tpl" */?>
								...
								<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='file') {?>
									 ...
									 <?php if (isset($_smarty_tpl->tpl_vars['input']->value['image'])&&!empty($_smarty_tpl->tpl_vars['input']->value['image'])) {?>
										<?php $_smarty_tpl->tpl_vars['show_thumbnail'] = new Smarty_variable(true, null, 0);?>
									<?php }?>
																	 
									 <?php if ($_smarty_tpl->tpl_vars['show_thumbnail']->value) {?>
										<?php $_smarty_tpl->tpl_vars['id'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['name'], null, 0);?>
										<?php $_smarty_tpl->tpl_vars['max_files'] = new Smarty_variable(1, null, 0);?>
										 <div class="form-group">
...
-images-thumbnails">
												 	...
												 	<?php if (isset($_smarty_tpl->tpl_vars['input']->value['image'])&&$_smarty_tpl->tpl_vars['input']->value['type']=='file') {?>
												<div>
													<?php echo $_smarty_tpl->tpl_vars['input']->value['image'];?>

													<?php if (isset($_smarty_tpl->tpl_vars['input']->value['size'])) {?><p><?php echo smartyTranslate(array('s'=>'File size'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->tpl_vars['input']->value['size'];?>
kb</p><?php }?>
													 
													<?php if (isset($_smarty_tpl->tpl_vars['input']->value['delete_url'])) {?>
													<p>
														<a class="btn btn-default" href="<?php echo $_smarty_tpl->tpl_vars['input']->value['delete_url'];?>
">
...
',
				is_default: '<?php if (isset($_smarty_tpl->tpl_vars['language']->value['is_default'])) {?><?php echo $_smarty_tpl->tpl_vars['language']->value['is_default'];?>
<?php }?>'
			};
		<?php } ?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-03-08 02:40:13
         compiled from "C:\wamp64\www\prestashop\adminqq\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5aa0ccbdbed088_31165641')) {function content_5aa0ccbdbed088_31165641($_smarty_tpl) {?>
